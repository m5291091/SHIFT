...
class MemberShiftPatternPreference(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "99. シフトパターン優先度"
...
class ShiftPattern(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "05. シフトパターン"
...
class TimeSlotRequirement(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "06. 時間帯別必要人数"
...
class RelationshipGroup(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "09. 関係性グループ"
...
class GroupMember(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "10. グループ所属メンバー"
...
class OtherAssignment(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "14. その他の割り当て"
...
class SpecificDateRequirement(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "07. 特定日別シフト必要人数"
...
class SpecificTimeSlotRequirement(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "08. 特定日別時間帯必要人数"
